# Auxiliary functions for "ATS"-functionality. 
# These are adopted and modified from the package "sensitivity" (Gilles Pujol, 
# Bertrand Iooss, Alexandre Janon with contributions from Sebastien Da Veiga, 
# Jana Fruth, Laurent Gilquin, Joseph Guillaume, Loic Le Gratiet, Paul Lemaitre,
# Bernardo Ramos and Taieb Touati (2015). sensitivity: Sensitivity Analysis. 
# R package version 1.11.1. http://CRAN.R-project.org/package=sensitivity).
...
ee.oat_ats <- function (X, Y) 
{
  ...
  ee_by_time <- lapply(1:t_num, function(i){
    ee_matrix[seq(i, nrow_ee_matrix, t_num), ]})
